 ...
 * Braces currently render at a "one size fits all" with a font size of 200%, rather than fitting to content.
 * Text that appears over/under other text has a large gap (e.g. `lim_(x->oo)`)
